        ...
        <>
            <div className="relative h-screen text-white">
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black to-black/20 ">
                    <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} className="absolute top-0 left-0 object-cover w-full h-full -z-50" alt="Hero img" />
                </div>
                <div className="absolute flex items-center justify-center w-full h-full top-0 sm:justify-normal left-0 md:px-16">
                    <div className="max-w-xl p-4">
                        ...
                        <div className="mt-8 flex gap-4">
                            <Link to="#" className="flex bg-white items-center rounded-lg hover:bg-white/80 text-black font-bold py-2 px-4 gap-2">
